...
// AllocationCreateFlags wraps the bitmask VmaAllocationCreateFlagBits.
//
...
func (e AllocationCreateFlags) String() string {
	return fmt.Sprintf("VmaAllocationCreateFlagBits(%b)", e)
}

// AllocatorCreateFlags wraps the bitmask VmaAllocatorCreateFlagBits.
//
...
func (e AllocatorCreateFlags) String() string {
	return fmt.Sprintf("VmaAllocatorCreateFlagBits(%b)", e)
}

// DefragmentationFlags wraps the bitmask VmaDefragmentationFlagBits.
//
...
func (e DefragmentationFlags) String() string {
	return fmt.Sprintf("VmaDefragmentationFlagBits(%b)", e)
}

// PoolCreateFlags wraps the bitmask VmaPoolCreateFlagBits.
//
...
func (e PoolCreateFlags) String() string {
	return fmt.Sprintf("VmaPoolCreateFlagBits(%b)", e)
}

// VirtualAllocationCreateFlags wraps the bitmask VmaVirtualAllocationCreateFlagBits.
//
...
func (e VirtualAllocationCreateFlags) String() string {
	return fmt.Sprintf("VmaVirtualAllocationCreateFlagBits(%b)", e)
}

// VirtualBlockCreateFlags wraps the bitmask VmaVirtualBlockCreateFlagBits.
//
...
func (e VirtualBlockCreateFlags) String() string {
	return fmt.Sprintf("VmaVirtualBlockCreateFlagBits(%b)", e)
}
